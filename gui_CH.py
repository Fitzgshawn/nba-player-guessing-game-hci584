...
class App(Tk):  # derives your class from TK, so you can run it's inherited mainloop()
    def __init__(self):
        ...
        self.go = Button(self, text=" Go!", command=self.eval_answer)
